...
PSST_SHORT_DEFS = {
    ...
    "Activity": "Action that an agent undertakes for a period of time. {at, from, into, on}", 
    ...
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {above, after, before, behind, below, beneath, for, next to, over, under}", 
    ...
    "Stimulus": "That which is perceived or experienced. {at, by, of, with}", 
    "Superset": "Discrete containing set. {among, in, of, out of, outside, within}", 
    "Temporal": "Macro-role for temporal characteristics. {by}", 
    "Theme": "Central undergoer that is not in control over the event, not structurally changed by the event, and/or is characterized as being in a certain position or condition. {for, of, on, to, with}", 
