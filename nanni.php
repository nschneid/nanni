...
PSST_SHORT_DEFS = {
    ...
    "Approximator": "Measurement, quantity, or range being &quot;transformed&quot; by the preposition. {about, around, between, over, under}", 
    "Attribute": "Characteristic, feature, part, or possessum of an entity. {as, by, in, of, with, without}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as per, for, in, in accord with, in accordance with, in keeping with, in line with, per, pursuant to, under, with, without}", 
    ...
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, at, away, back, down, in, into, off, out, towards, up}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {after, as, because of, by virtue of, due to, for, on account of, owing to, since, thanks to}", 
    ...
    "Location": "Concrete location. {about, above, across, against, all over, among, around, at, before, behind, below, beneath, beside, between, by, down, from, in, in front of, inside, inside of, near, next to, of, off, on, on top of, out of, outside, outside of, over, past, round, through, to, under, up, within, without}", 
    "Locus": "Abstract location. {among, at, in, on, within}", 
    "Manner": "How something happens. {by, in, on, with}", 
    ...
    "State": "State of affairs. {all over, around, at, in, in need of, near, off, on, out of, under}", 
...
"as": {"Attribute": [257, "it came as a shock", "she got a job as a cook."], 
    "Circumstance": [0, "here are the pictures as you requested", "As we read in chapter one of this book, the six days of creation starting in Genesis 1:2 are not the beginning of the world, but the renewal or recreation of the Earth for the second Heaven and Earth age"], 
...
"from": {"Causer": [71, "a child suffering from asthma."], 
...
"with": {"3DMedium": [0, "marine mammals generally swim with the current."], 
    ...
    "Stimulus": [146, "he was trembling with fear.", "the teacher was unhappy with the student's work"], 
...
"without": {"Accompanier": [0, "Others never venture into the outside world without a chaperone."], 
    ...
    "Circumstance": [0, "a magic man who walks through fire without being burned.", "It is very sad that these people can't manage an hour or so without smoking."], 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "except": ["Elements"],
    "except for": ["Elements"],
    "for": ["Purpose", "Theme", "Function", "Reciprocation", "Explanation", "Circumstance", "Beneficiary", "Experiencer", "`", "Stimulus", "Recipient", "Duration", "DeicticTime", "Topic", "Scalar/Rank", "ProfessionalAspect", "Value", "Co-Theme", "Time", "Destination", "Frequency", "Extent"],
    ...
    "onto": ["Destination"],
    "out": ["Direction"],
    "out of": ["Superset", "State", "Source", "Material", "Location", "InitialLocation", "1DTrajectory"],
    ...
    "to": ["Beneficiary", "Destination", "Recipient", "EndState", "Co-Theme", "Patient", "Experiencer", "Theme", "ProfessionalAspect", "Location", "`i", "`d", "Value", "Purpose", "Function", "EndTime", "Comparison/Contrast", "ClockTimeCxn"],
