...
PSST_SHORT_DEFS = {
    ...
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as opposed to, beside, between, from, instead of, like, near, than, to}", 
    ...
    "Elements": "Member or non-member of a set of discrete items. {apart from, aside from, besides, but, except, except for, in addition to, like, of, on top of, such as}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {after, as, because of, by virtue of, due to, for, on account of, owing to, thanks to}", 
    ...
    "Location": "Concrete location. {about, above, across, against, all over, among, around, at, before, behind, below, beneath, beside, between, by, down, from, in, in front of, inside, near, of, off, on, on top of, out of, outside, over, past, round, through, to, under, up, within, without}", 
    ...
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {above, after, before, behind, below, beneath, for, over, under}", 
