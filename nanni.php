...
PSST_LIST_OF_LABELS = ['1DTrajectory', '2DArea', '3DMedium', 'Accompanier', 'Activity',
    ...
    'Causer', 'ClockTimeCxn', 'Co-Agent', 'Co-Patient', 'Co-Theme',
    'Comparison/Contrast', 'Contour', 'Course', 'Creator',
    'DeicticTime', 'Destination', 'Direction', 'Donor/Speaker',
    'Duration', 'Elements', 'EndState', 'EndTime', 'Experiencer',
    'Explanation', 'Extent', 'Frequency', 'Function', 'Goal',
    'InitialLocation', 'Instrument', 'Location', 'Locus', 'Manner',
    'Material', 'Means', 'Other', 'Partitive', 'Patient', 'Possessor',
    'ProfessionalAspect', 'Purpose', 'Recipient', 'Reciprocation',
...
PSST_SHORT_DEFS = {
    ...
    "2DArea": "Two-dimensional area that is the location traversed. {around, about, round}", 
    ...
    "Approximator": "Measurement, quantity, or range being &quot;transformed&quot; by the preposition. {under, over, around, between, about}", 
    "Attribute": "Characteristic, feature, part, or possessum of an entity. {as, in, by, with, of}", 
    "Beneficiary": "Undergoer that is (potentially) advantaged or disadvantaged by the event or state. {for, by, to, towards, on, against}", 
    "Causer": "Force/party that precipitates an event (and is a central participant of it). {from, by, with, of}", 
    "Circumstance": "Abstract macro-role. {}", 
    "ClockTimeCxn": "In constructions for telling time, the hour part. {to, after, of}", 
    "Co-Agent": "Participant acting symmetrically with the agent. {by, with, between, against}", 
    "Co-Patient": "Undergoer symmetrical to the Patient. {between}", 
    "Co-Theme": "Undergoer symmetrical to the Theme. {from, for, to, with, between}", 
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {near, as opposed to, from, beside, to, after, between, like, against}", 
    ...
    "Course": "Pathway used for travel. {up, down, through, by}", 
    ...
    "Destination": "Endpoint (actual or intended) of physical motion. {into, up, down, through, at, in, for, to, over, on, inside, against, onto, round}", 
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {into, at, towards, after, off}", 
    "Donor/Speaker": "Animate starting point in a transfer scenario; counterpart to Recipient. {from}", 
    "Duration": "Temporal length of an event. {into, down, through, in, for, over, during, across}", 
    "Elements": "Member or non-member of a set of discrete items. {except, such as, but, like}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {on account of, owing to, for, by virtue of, after, because of}", 
    "Extent": "Size of a path. {through, for, by, of}", 
    "Frequency": "Temporal rate or repetitions. {at, for, by, after}", 
    "Function": "The function that an entity serves, or for which it was made. {for, by, to, towards}", 
    ...
    "Location": "Concrete location. {among, within, near, up, down, through, at, in, before, from, by, beside, to, outside, above, under, out of, over, around, behind, between, on, about, off, of, inside, against, across, below, without, beneath, round}", 
    "Locus": "Abstract location. {among, at, in, on}", 
    "Manner": "How something happens. {in, by, with}", 
    "Material": "Ingredients/material from which something is made. {from, of}", 
    "Means": "An activity that facilitates achieving some purpose. {through, by, with}", 
    ...
    "Patient": "Undergoer in an event that experiences a change of state, location or condition, that is causally involved or directly affected by other participants, and exists independently of the event. {over}", 
    "Place": "Abstract macro-role. {}", 
    "Possessor": "Possessor of an entity (including kin) or attribute. {behind, on, about, of}", 
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, in, for, to, outside, with, on}", 
    "Purpose": "Thing or result that the agent seeks to obtain by performing an action, and which is the agent's reason for performing the action. {for, to}", 
    ...
    "RelativeTime": "Time before or after some reference point. {before, since, by, towards, after, between}", 
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {before, for, above, under, over, behind, after, below, beneath}", 
    ...
    "State": "State of affairs. {near, at, in, under, on, off}", 
    "Stimulus": "That which is perceived or experienced. {at, with}", 
    "Superset": "Discrete containing set. {among, out of, of}", 
    "Temporal": "Macro-role for temporal characteristics. {by}", 
    "Theme": "Central undergoer that is not in control over the event, not structurally changed by the event, and/or is characterized as being in a certain position or condition. {for, to, with, of}", 
    "Time": "Point in time. {near, at, in, around, on}", 
    "Topic": "Information content. {into, for, over, towards, around, with, on, about, of, round}", 
    ...
    "Value": "Point on a formal scale. {into, at, in, for, by, to, of}", 
    "ValueComparison": "Value being compared to some other value on a scale. {near, above, below}", 
    "Via": "Path/instrument that enables concrete or abstract entities (including information, etc.) to get from one place to another. {through, over, on}", 
...
"because of": {"Explanation": [250, "Some would even say the only reason they go to watch Tranmere is because of Iain alone.", "The obvious point being that they were not siding with them because of those values.", "After a couple of years we closed down because of lack of interest by adults in the village.", "The loss of a handful of email messages because of a technical glitch is an irritation.", "He also has a broad basis of support because of his background as a trade union official."]},
...
"by": {"1DTrajectory": [0, "I drove by our house."], 
    ...
    "Causer": [98, "damage caused by fire."], 
...
"for": {"Beneficiary": [337, "Eating healthy food is good/expensive/important for students ((semantically, adj. takes a predicate AND a participant as arguments))", "troops who had fought for Napoleon", "the High Court found for the Commissioner", "I got a present for you", "these parents aren't speaking for everyone."], 
    ...
    "Experiencer": [204, "It is difficult/enjoyable for students to eat gourmet food ((students experience difficulty/joy))", "it was a significant victory for Hussein"], 
    ...
    "Purpose": [766, "Blackbeard seemed ready to murder us for a wallet with a few fivers in it", "the necessary tools for making a picture frame."], 
    ...
    "Theme": [61, "you have a great desire for solitude", "charge higher prices for goods bought by credit card"], 
...
"of": {"Age": [6, "a boy of 15."], 
    ...
    "Partitive": [1222, "a bag of popcorn", "nine of the children came to the show", "a series of programmes", "a piece of cake."], 
    ...
    "Superset": [191, "the days of the week."], 
    ...
    "Whole": [191, "the sleeve of his coat", "in the back of the car", "the headquarters of the company"]},
...
"out of": {"InitialLocation": [0, "Then, without a word, he stormed out of the room, slamming the door shut as he went.", "I grabbed a piece of toast and let myself out of the house.", "They led their horses on foot along the single narrow road that led out of the forest."], 
    "Location": [0, "We picked up a hitchhiker about ten miles out of town."], 
    "Superset": [19, "Nine out of ten people are there to study and prepare for the upcoming school or job exam or test.", "Nine times out of ten this is a big mistake.", "On a day when the fixture list was badly hit by the weather, only nine matches were played out of 19 scheduled.", "To pass the examinations a score of 6 out of ten had to be achieved.", "The inspectors also found dust on bed frames, bed lamps and bed curtain rails in seven out of ten wards at the hospital."]},
...
"under": {"Approximator": [0, "Jacques Chirac, the right wing president, scraped just under 20 percent of the vote.", "The majority of cases in Angola have occurred in children under the age of five years.", "Mr Delaney said he was very happy to report that he had a heart rate of under 60 beats to the minute.", "Which meant if I ran the second half at the same speed I would have finished in under four hours.", "I define roadster as under two litres, fun, dependable, cheap to run, with low maintenance."], 
    "Location": [0, "Pity the display was directly under the departures board which had a long list of delayed and cancelled trains.", "It was only the very quick reaction of the driver that prevented the scooter finishing up under the bus wheels.", "They dislike being planted under trees or in soil that gets waterlogged.", "Huge reserves of fossil fuels remain to be even considered, let alone tapped, eg gas hydrates under the oceans.", "Richey is looking forward to experiencing the things we take for granted, such as feeling grass under his feet.", "Another had lain on a chaise lounge for four days, his stockinged feet poking out from under a quilt.", "Fruit cell turgors were obtained by probing the mesocarp cells directly under the fruit epidermis.", "I put the note down under the plate and turned around to find Daniel in my face.", "Maybe they were dejectedly resigned to seeing another green field site disappear under tons of concrete?", "The cat thought it was great fun and climbed under the duvet with me.", "He landed in an old storage room somewhere under the museum, where he was he had no idea.", "Dropping forward onto the walkway around the hold it is possible to swim into the crew's quarters under the chart room.", "The luggage compartment floor is on two levels, under which the rear seat base can be stowed."], 
    "Scalar/Rank": [0, "We have a layer of stewards under the branch secretaries who also filter this democracy down.", "I learned long ago that I had to give the managers under me the ability to make mistakes or I'd lose good people.", "Knight, who worked under Babcock as Director of Basketball Operations, has previous experience as a General Manager from his two seasons with the Vancouver/Memphis Grizzlies.", "Three principal planning officers will head the team under a development control manager."], 
    "State": [0, "The process put us under a lot of stress, and we felt that something shameful and wrong had occurred.", "These trees can start producing fruit within about six years under the right conditions.", "I don't think of us are under any illusions about those elections.", "Plants were cultivated under the same conditions as in hydroponic culture.", "He said that management had done its best to retain a viable share of the market under difficult trading conditions."]},
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "but": ["Elements"],
    "by": ["Agent", "Means", "Causer", "Extent", "Creator", "Location", "Transit", "Course", "Attribute", "Function", "Temporal", "RelativeTime", "Value", "Other", "Manner", "Frequency", "Co-Agent", "Beneficiary", "1DTrajectory"],
    "by virtue of": ["Explanation"],
    "down": ["Location", "Course", "1DTrajectory", "Duration", "Destination"],
    "during": ["Duration"],
    "except": ["Elements"],
    "for": ["Purpose", "Function", "Reciprocation", "Explanation", "Beneficiary", "Experiencer", "`", "Duration", "DeicticTime", "Theme", "Topic", "Scalar/Rank", "ProfessionalAspect", "Value", "Co-Theme", "Destination", "Frequency", "Extent"],
    ...
    "in": ["Location", "Locus", "Attribute", "Destination", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Value", "Duration"],
    ...
    "of": ["Partitive", "Topic", "Possessor", "Species", "Whole", "Superset", "Theme", "Material", "Causer", "Attribute", "Creator", "Value", "Extent", "Age", "Location", "ClockTimeCxn"],
    "off": ["InitialLocation", "Source", "Direction", "Location", "State"],
    "on": ["Location", "Topic", "Destination", "Goal", "Beneficiary", "Time", "Other", "Locus", "Via", "State", "Activity", "Possessor", "ProfessionalAspect"],
    "on account of": ["Explanation"],
    "onto": ["Destination"],
    "out of": ["Superset", "Location", "InitialLocation"],
    ...
    "under": ["State", "Scalar/Rank", "Location", "Approximator"],
    "until": ["EndTime"],
    "up": ["Location", "Course", "Destination", "1DTrajectory"],
    "with": ["Stimulus", "Theme", "Accompanier", "Means", "Instrument", "Co-Agent", "Attribute", "Manner", "Topic", "Causer", "ProfessionalAspect", "Co-Theme", "3DMedium"],
    "within": ["Location"],
    "without": ["Location"]
};
