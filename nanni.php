...
PSST_SHORT_DEFS = {
    ...
    "Activity": "Action that an agent undertakes for a period of time. {at, into, on}", 
    ...
    "DeicticTime": "Earlier or later time expressed by the length of an interval relative to an implicit reference time. {before, for, in, inside, within}", 
    ...
    "Partitive": "Type-specific measure phrase. (For a general quantifier or measurement, use Whole or Superset.) {of}", 
    "Path": "Abstract region between an initial position and a final position. {}", 
    "Patient": "Undergoer in an event that experiences a change of state, location or condition, that is causally involved or directly affected by other participants, and exists independently of the event. {of, over, to}", 
    ...
    "Purpose": "Something that somebody wants to bring about. {for, to}", 
    ...
    "State": "State of affairs. {all over, at, in, in need of, near, off, on, under}", 
...
"in": {"Age": [142, "a woman in her thirties."], 
    ...
    "Time": [98, "they met in 1885", "at one o'clock in the morning", "In my life I have never seen so many cats on the floor", "the leaders met for the 8th time in 6 weeks"], 
...
"to": {"Beneficiary": [703, "you were terribly unkind to her", "priced to be affordable to domestic users", "She was rude to Larry Hagman"], 
    ...
    "`i": [0, "I want to suck your blood", "To win is my greatest desire", "I am happy to meet you halfway"]},
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "in": ["Location", "Superset", "Locus", "Attribute", "Topic", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Duration", "Direction"],
    ...
    "onto": ["Destination"],
    "out": ["Direction"],
    "out of": ["Superset", "Source", "Material", "Location", "InitialLocation", "1DTrajectory"],
    ...
    "with": ["Theme", "Topic", "Recipient", "Co-Theme", "Beneficiary", "Accompanier", "Means", "Instrument", "Stimulus", "Co-Agent", "Attribute", "Manner", "Causer", "ProfessionalAspect", "Circumstance", "3DMedium"],
