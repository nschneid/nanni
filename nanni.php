...
PSST_SHORT_DEFS = {
    ...
    "Attribute": "Characteristic, feature, part, or possessum of an entity. {as, by, in, of, with}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {for, in, with}", 
    ...
    "DeicticTime": "Earlier or later time expressed by the length of an interval relative to an implicit reference time. {before, for, in, inside}", 
    ...
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, at, away, back, in, into, off, out, towards}", 
    ...
    "Elements": "Member or non-member of a set of discrete items. {apart from, aside from, besides, but, except, except for, in addition to, like, of, on top of, such as, with the exception of}", 
    ...
    "Location": "Concrete location. {about, above, across, against, all over, among, around, at, before, behind, below, beneath, beside, between, by, down, from, in, in front of, inside, near, next to, of, off, on, on top of, out of, outside, over, past, round, through, to, under, up, within, without}", 
    ...
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, for, in, on, outside, to, under, with}", 
    ...
    "Superset": "Discrete containing set. {among, in, of, out of}", 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "concerning": ["Topic"],
    "down": ["Location", "Course", "1DTrajectory", "Duration"],
    "due to": ["Explanation"],
    "during": ["Duration"],
    "except": ["Elements"],
    "except for": ["Elements"],
    ...
    "until": ["EndTime"],
    "up": ["Location", "Course", "1DTrajectory"],
