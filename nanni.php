...
PSST_LIST_OF_LABELS = ['1DTrajectory', '2DArea', '3DMedium', 'Accompanier', 'Activity',
    ...
    'Goal', 'InitialLocation', 'Instance', 'Instrument', 'Location',
    'Locus', 'Manner', 'Material', 'Means', 'Patient', 'Possessor',
    'ProfessionalAspect', 'Purpose', 'Quantity', 'Recipient',
...
PSST_SHORT_DEFS = {
    ...
    "Co-Participant": "Core participant portrayed as secondary. {}", 
    ...
    "Recipient": "Animate intended recipient of something concrete or abstract. Includes addressees. {for, to, with}", 
    ...
    "Stimulus": "That which is perceived or experienced (bodily, perceptually, or emotionally). {about, at, by, for, of, to, with}", 
...
"with": {"3DMedium": [0, "marine mammals generally swim with the current."], 
    "Accompanier": [274, "a nice steak with a bottle of red wine.", "Boris still lives with his parents", "He shares a last name with me"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "Stimulus", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "as to": ["Topic"],
    "aside from": ["Elements"],
    "at": ["Location", "Goal", "Stimulus", "Value", "Frequency", "Time", "Activity", "Direction", "Instrument", "State", "Age", "ProfessionalAspect", "Locus"],
    "at all": ["Extent"],
    ...
    "in": ["Location", "Theme", "Activity", "Superset", "Locus", "Attribute", "Topic", "Patient", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Instance", "Duration", "Direction"],
    ...
    "with": ["Theme", "Topic", "Recipient", "Co-Theme", "Beneficiary", "Activity", "Accompanier", "Means", "Instrument", "Stimulus", "Co-Agent", "Attribute", "Manner", "Causer", "ProfessionalAspect", "Circumstance", "3DMedium"],
