...
PSST_SHORT_DEFS = {
    ...
    "Approximator": "Measurement, quantity, or range being &quot;transformed&quot; by the preposition. {about, around, at least, at most, between, just about, over, under}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as per, for, in, in accord with, in accordance with, in keeping with, in line with, per, pursuant to, under, with}", 
    ...
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as opposed to, beside, between, from, instead of, like, near, next to, rather than, than, to}", 
    ...
    "DeicticTime": "Earlier or later time expressed by the length of an interval relative to an implicit reference time. {ago, back, before, for, in, inside, within}", 
    ...
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, at, away, back, down, home, in, into, off, out, towards, up}", 
    ...
    "Elements": "Member or non-member of a set of discrete items. {apart from, aside from, besides, but, except, except for, in addition to, like, of, on top of, outside of, such as, with the exception of}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {after, as, because of, by virtue of, due to, for, on account of, out of, owing to, since, thanks to}", 
    ...
    "Goal": "Abstract intended endpoint or outcome. {at, on, towards}", 
    ...
    "Locus": "Abstract location. {among, at, in, on, within}", 
    ...
    "Partitive": "Classifier (type-specific measure phrase a.k.a. unitizer). (For a general quantifier or measurement, use Whole or Superset.) {of}", 
    ...
    "State": "State of affairs. {all over, around, at, in, in need of, near, off, on, out of, to, under}", 
    "Stimulus": "That which is perceived or experienced. {at, by, for, of, with}", 
    "Superset": "Discrete containing set. {among, in, of, out of, outside, within}", 
    "Temporal": "Macro-role for temporal characteristics. {by}", 
    "Theme": "Central undergoer that is not in control over the event, not structurally changed by the event, and/or is characterized as being in a certain position or condition. {for, from, of, on, to, with}", 
...
"for": {"Attribute": [381, "the ride screens children for height"], 
    ...
    "Function": [395, "the \"F\" is for Fascinating.", "networks for the exchange of information", "a great night for a party", "a coupon for peanut butter"], 
...
"in": {"Activity": [542, "many scientists were involved in putting a man on the moon", "they were prompt in their response"], 
    ...
    "Location": [1019, "I'm living in London", "she saw the bus in the rear-view mirror.", "don't put coal in the bath", "he got in his car and drove off."], 
...
"of": {"Age": [6, "a boy of 15."], 
    ...
    "Possessor": [1208, "it was kind of you to ask", "the son of a friend", "the government of India", "a former colleague of John's.", "The smug foolishness of the Western leaders was typified by the British participants.", "the opinion of the directors"], 
    "Species": [595, "the city of Prague", "the idea of a just society", "the population of interbreeding individuals", "this type of book.", "One of the best types of ant to keep is the red ant .", "certain strains of Escherichia coli", "Modern breeds of these homing pigeons return reliably", "Some poor sap made the mistake of his career and applied the wrong brand of paint"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "concerning": ["Topic"],
    "down": ["Location", "Course", "1DTrajectory", "Duration", "Direction"],
    "due to": ["Explanation"],
    "during": ["Duration"],
    "except": ["Elements"],
    "except for": ["Elements"],
    ...
    "from": ["InitialLocation", "StartState", "Source", "Donor/Speaker", "ProfessionalAspect", "Location", "Co-Theme", "Causer", "Comparison/Contrast", "Material", "StartTime", "Theme"],
    "home": ["Location", "Direction"],
    "in": ["Location", "Activity", "Superset", "Locus", "Attribute", "Topic", "Patient", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Duration", "Direction"],
    ...
    "of": ["Partitive", "Possessor", "Whole", "Superset", "Topic", "Theme", "Patient", "Species", "Agent", "Material", "Elements", "Stimulus", "Causer", "Attribute", "Creator", "Value", "Extent", "Age", "Location", "ClockTimeCxn"],
    "off": ["InitialLocation", "Source", "Direction", "Location", "State"],
    "on": ["Location", "Topic", "State", "Manner", "Theme", "Goal", "Beneficiary", "Time", "Other", "Locus", "Via", "Activity", "Possessor", "ProfessionalAspect"],
    ...
    "to": ["Beneficiary", "Destination", "Recipient", "EndState", "Co-Theme", "Patient", "Experiencer", "Theme", "ProfessionalAspect", "Location", "State", "`i", "`d", "Value", "Purpose", "Function", "EndTime", "Comparison/Contrast", "ClockTimeCxn"],
    ...
    "until": ["EndTime"],
    "up": ["Location", "Course", "Direction", "1DTrajectory"],
