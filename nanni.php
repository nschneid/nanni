...
PSST_SHORT_DEFS = {
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as long as, as per, depending on, despite, for, in, in accord with, in accordance with, in keeping with, in line with, in spite of, per, pursuant to, regardless of, so long as, under, with}", 
    ...
    "Extent": "Size of a path. {at all, by, for, of, through}", 
    ...
    "Patient": "Undergoer in an event that experiences a change of state, location or condition, that is causally involved or directly affected by other participants, and exists independently of the event. {in, of, over, to}", 
    "Place": "Abstract macro-role. {}", 
    "Possessor": "Possessor of an entity (including kin) or attribute. {about, behind, of, on}", 
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, for, from, in, on, to, under, with}", 
    ...
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {above, after, before, behind, below, beneath, for, next to, over, than, under}", 
    "Source": "Abstract starting point. {from, off, out of}", 
    "Species": "A category qualified by ''species'', ''breed'', ''kind'', ''type'', ''variety'', etc. {of}", 
    "StartState": "Initial state or beginning of a range on a scale. {from}", 
    ...
    "Time": "Point in time. {around, as, as soon as, at, for, in, near, on}", 
...
"of": {"Age": [6, "a boy of 15."], 
    ...
    "Possessor": [1208, "it was kind of you to ask", "the son of a friend", "the government of India", "a former colleague of John's.", "The smug foolishness of the Western leaders was typified by the British participants.", "What was the time of the party?", "the opinion of the directors"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "Stimulus", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "as to": ["Topic"],
    "aside from": ["Elements"],
    "at": ["Location", "Recipient", "Goal", "Stimulus", "Value", "Frequency", "Time", "Activity", "Direction", "Instrument", "State", "Age", "ProfessionalAspect", "Locus"],
    "at all": ["Extent"],
    ...
    "beyond": ["RelativeTime", "State", "Location", "Elements"],
    "but": ["Elements"],
    ...
    "of": ["Quantity", "Possessor", "Whole", "Superset", "Topic", "Theme", "Patient", "Instance", "Agent", "Material", "Elements", "Stimulus", "Causer", "Species", "Attribute", "Creator", "Value", "Extent", "Age", "Location", "Comparison/Contrast", "ClockTimeCxn"],
    "off": ["InitialLocation", "Source", "Direction", "Location", "State"],
    "on": ["Location", "Topic", "Manner", "State", "Explanation", "Theme", "Goal", "Beneficiary", "Time", "Instrument", "Locus", "Via", "Activity", "Possessor", "ProfessionalAspect"],
    "on account of": ["Explanation"],
    "on top of": ["Location", "Elements"],
    "onto": ["Destination"],
    "other than": ["Elements"],
    "out": ["State", "Location", "Direction"],
    "out of": ["Superset", "Explanation", "State", "Source", "Material", "Location", "InitialLocation", "1DTrajectory"],
    "outdoors": ["Location"],
    ...
    "without": ["Manner", "Location", "Instrument", "Attribute", "Accompanier"]
};
