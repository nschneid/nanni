...
PSST_SHORT_DEFS = {
    ...
    "Beneficiary": "Animate or personified undergoer that is (potentially) advantaged or disadvantaged by the event or state. {for, by, to, towards, with, on, against}", 
    ...
    "Destination": "Endpoint (actual or intended) of physical motion. {into, up, down, through, at, in, for, to, under, over, on, inside, against, onto, round}", 
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {into, at, away, towards, after, back, off}", 
    ...
    "Elements": "Member or non-member of a set of discrete items. {except, such as, but, like, of}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {on account of, owing to, for, by virtue of, after, because of, due to}", 
    ...
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, in, for, to, outside, under, with, on}", 
    ...
    "Time": "Point in time. {near, at, in, for, around, on}", 
...
"for": {"Beneficiary": [337, "Eating healthy food is good/expensive/important for students ((semantically, adj. takes a predicate AND a participant as arguments))", "troops who had fought for Napoleon", "the High Court found for the Commissioner", "I got a present for you", "these parents aren't speaking for everyone."], 
    ...
    "Purpose": [766, "Blackbeard seemed ready to murder us for a wallet with a few fivers in it", "I had peanut butter for lunch", "the necessary tools for making a picture frame."], 
...
"in": {"Age": [142, "a woman in her thirties."], 
    ...
    "Superset": [0, "Perhaps only one in twenty of the city's adult residents had been born there."], 
...
"on": {"Activity": [3, "his attendant was out on errands."], 
    ...
    "Goal": [86, "five air raids on Schweinfurt", "thousands marching on Washington", "her eyes were fixed on his dark profile.", "the mechanic worked on the engine"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "during": ["Duration"],
    "except": ["Elements"],
    "for": ["Purpose", "Function", "Reciprocation", "Explanation", "Beneficiary", "Experiencer", "`", "Duration", "DeicticTime", "Theme", "Topic", "Scalar/Rank", "ProfessionalAspect", "Value", "Co-Theme", "Time", "Destination", "Frequency", "Extent"],
    ...
    "in": ["Location", "Locus", "Attribute", "Destination", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Value", "Superset", "Duration"],
    ...
    "with": ["Theme", "Beneficiary", "Accompanier", "Means", "Instrument", "Stimulus", "Co-Agent", "Attribute", "Manner", "Topic", "Causer", "ProfessionalAspect", "Co-Theme", "3DMedium"],
    "within": ["Location"],
    "without": ["Location"]
};
