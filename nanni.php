...
PSST_SHORT_DEFS = {
    ...
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as opposed to, beside, between, from, instead of, like, near, next to, than, to}", 
    ...
    "Extent": "Size of a path. {by, for, of, through}", 
    ...
    "Manner": "How something happens. {according to, by, in, with}", 
    ...
    "Patient": "Undergoer in an event that experiences a change of state, location or condition, that is causally involved or directly affected by other participants, and exists independently of the event. {over, to}", 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "on": ["Location", "Topic", "Theme", "Goal", "Beneficiary", "Time", "Other", "Locus", "Via", "State", "Activity", "Possessor", "ProfessionalAspect"],
