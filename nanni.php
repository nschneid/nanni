...
PSST_LIST_OF_LABELS = ['1DTrajectory', '2DArea', '3DMedium', 'Accompanier', 'Activity',
    ...
    'Value', 'ValueComparison', 'Via', 'Whole', '`', '`i', '`a', '`d',
    '`j', '`o', '?'];

PSST_SHORT_DEFS = {
    "1DTrajectory": "One-dimensional path that is the location traversed. {up, past, through, between, by, above, out of, over, around, along, down, about, across, round}", 
    ...
    "Beneficiary": "Animate or personified undergoer that is (potentially) advantaged or disadvantaged by the event or state. {for, by, to, towards, on, with, against}", 
    "Causer": "Force/party that precipitates an event (and is a central participant of it). {from, by, with, of}", 
    "Circumstance": "Abstract macro-role. {in, with}", 
    "ClockTimeCxn": "In constructions for telling time, the hour part. {past, to, after, of}", 
    "Co-Agent": "Participant acting symmetrically with the agent. {between, by, with, against}", 
    "Co-Patient": "Undergoer symmetrical to the Patient. {between}", 
    "Co-Theme": "Undergoer symmetrical to the Theme. {between, from, for, to, with}", 
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {between, as opposed to, from, beside, to, after, than, like, against, near}", 
    ...
    "Course": "Pathway used for travel. {via, up, through, by, down}", 
    ...
    "Destination": "Endpoint (actual or intended) of physical motion. {into, up, through, at, in, for, to, under, over, on, down, inside, against, onto, round}", 
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {into, back, at, away, towards, after, off}", 
    "Donor/Speaker": "Animate starting point in a transfer scenario; counterpart to Recipient. {from}", 
    "Duration": "Temporal length of an event. {into, through, in, for, over, during, down, across}", 
    ...
    "Explanation": "Secondary event that is asserted as the reason for the main event. {on account of, owing to, as, for, by virtue of, after, because of, due to}", 
    ...
    "Location": "Concrete location. {among, within, up, past, through, at, in, between, before, from, below, by, beside, to, outside, above, under, out of, over, around, behind, on, down, about, off, of, inside, against, across, near, without, beneath, round}", 
    ...
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, in, for, to, outside, under, on, with}", 
    ...
    "RelativeTime": "Time before or after some reference point. {past, between, before, since, by, towards, after}", 
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {before, for, below, above, under, over, behind, after, beneath}", 
    ...
    "State": "State of affairs. {at, in, under, on, off, near}", 
    ...
    "Theme": "Central undergoer that is not in control over the event, not structurally changed by the event, and/or is characterized as being in a certain position or condition. {for, to, on, with, of}", 
    "Time": "Point in time. {at, in, for, around, on, near}", 
    "Topic": "Information content. {into, in, for, over, towards, around, on, with, about, of, round}", 
    ...
    "ValueComparison": "Value being compared to some other value on a scale. {below, above, near}", 
...
"for": {"Beneficiary": [337, "Eating healthy food is good/expensive/important for students ((semantically, adj. takes a predicate AND a participant as arguments))", "troops who had fought for Napoleon", "the High Court found for the Commissioner", "I got a present for you", "these parents aren't speaking for everyone."], 
    ...
    "Purpose": [766, "Blackbeard seemed ready to murder us for a wallet with a few fivers in it", "I had peanut butter for lunch", "I went to the store for eggs", "We hired a caterer for the party", "Friday is a good time for a party", "physical therapy for a leg injury", "the necessary tools for making a picture frame."], 
...
"on": {"Activity": [3, "his attendant was out on errands."], 
    ...
    "Theme": [86, "the mechanic worked on the engine", "spend a lot of money on textbooks"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "during": ["Duration"],
    "except": ["Elements"],
    "for": ["Purpose", "Theme", "Function", "Reciprocation", "Explanation", "Beneficiary", "Experiencer", "`", "Duration", "DeicticTime", "Topic", "Scalar/Rank", "ProfessionalAspect", "Value", "Co-Theme", "Time", "Destination", "Frequency", "Extent"],
    ...
    "in": ["Location", "Superset", "Locus", "Attribute", "Destination", "Topic", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Duration"],
