...
PSST_SHORT_DEFS = {
    ...
    "2DArea": "Two-dimensional area that is the location traversed. {about, all over, around, round}", 
    "3DMedium": "Three-dimensional medium that is traversed through. {through, with}", 
    "Accompanier": "Entity that another entity is together with. {along with, together, together with, with, without}", 
    "Activity": "Action that an agent undertakes for a period of time. {at, in, into, on, with}", 
    ...
    "Approximator": "Measurement, quantity, or range being &quot;transformed&quot; by the preposition. {about, around, at least, at most, between, just about, like, over, under}", 
    "Attribute": "Characteristic, feature, part, or possessum of an entity. {about, as, by, for, in, of, with, without}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as long as, as per, depending on, despite, for, in, in accord with, in accordance with, in keeping with, in line with, in spite of, per, pursuant to, so long as, under, with}", 
    ...
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as, as if, as opposed to, as though, beside, between, from, instead of, like, near, next to, of, rather than, than, to}", 
    ...
    "Destination": "Endpoint (actual or intended) of physical motion. Excludes prepositions that also mark simple Locations. {for, into, onto, over, round, to}", 
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, apart, at, away, back, down, home, in, into, off, out, over, together, towards, up}", 
    "Donor/Speaker": "Animate starting point in a transfer scenario; counterpart to Recipient. {by, from}", 
    "Duration": "Temporal length of an event. {across, as long as, down, during, for, in, into, over, through}", 
    "Elements": "Member or non-member of a set of discrete items. {apart from, aside from, besides, but, except, except for, in addition to, like, nothing but, of, on top of, outside of, such as, with the exception of}", 
    ...
    "Frequency": "Temporal rate or repetitions. {after, at, by, for}", 
    ...
    "Instance": "''X '''of''' Y'', where ''X'' is a category that disambiguates or reframes (a more specific thing) ''Y''. {of}", 
    "Instrument": "Thing that enables or facilitates achieving some purpose. {at, on, with, without}", 
    "Location": "Concrete location. {about, above, across, against, all over, among, apart, around, at, before, behind, below, beneath, beside, between, by, down, from, home, in, in front of, inside, inside of, near, next to, of, off, on, on top of, out of, outside, outside of, over, past, round, through, to, under, up, within, without}", 
    ...
    "RelativeTime": "Time before or after some reference point. {after, apart, before, between, by, past, since, towards}", 
    ...
    "State": "State of affairs. {all over, around, at, down, in, in need of, near, off, on, out of, to, under, up}", 
    "Stimulus": "That which is perceived or experienced. {at, by, for, of, to, with}", 
    ...
    "Topic": "Information content. {about, around, as regards, as to, concerning, for, in, into, of, on, over, re, regarding, round, towards, with}", 
    ...
    "ValueComparison": "Value being compared to some other value on a scale. {above, below, near}", 
...
PSST_LABELS = {"about": {"1DTrajectory": [18, "They skipped about my feet, a flock of lambs", "rotated 90 degrees clockwise about its lowest corner", "wrapped an arm about Emilia's shoulders"], 
    ...
    "Topic": [967, "I was thinking about you", "a book about ancient Greece", "there's nothing we can do about it."]},
...
"in": {"Activity": [542, "many scientists were involved in putting a man on the moon", "they were prompt in their response"], 
    ...
    "Location": [1019, "I'm living in London", "she saw the bus in the rear-view mirror.", "\"Put it in a box and mark it 'fra-gilee'.\"", "don't put coal in the bath", "he got in his car and drove off."], 
...
"over": {"1DTrajectory": [56, "he toppled over the side of the boat.", "she trudged over the lawn.", "glance over her shoulder"], 
    ...
    "Direction": [0, "The horses are grazing over by the farmhouse.", "We often walk over on Saturdays."], 
...
PSST_TOP_LABELS = {"about": ["Topic", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "in": ["Location", "Theme", "Activity", "Superset", "Locus", "Attribute", "Topic", "Patient", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Duration", "Direction"],
    ...
    "over": ["Location", "Topic", "1DTrajectory", "Patient", "Duration", "Destination", "Scalar/Rank", "Via", "Direction", "Approximator"],
    "owing to": ["Explanation"],
