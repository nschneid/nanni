...
PSST_SHORT_DEFS = {
    ...
    "Accompanier": "Entity that another entity is together with. {with, without}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {for, in, with, without}", 
    ...
    "Manner": "How something happens. {according to, by, in, on, with}", 
...
PSST_TOP_LABELS = {"about": ["Topic", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "under": ["State", "Scalar/Rank", "ProfessionalAspect", "Location", "Approximator"],
    "until": ["EndTime"],
