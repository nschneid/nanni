...
PSST_LIST_OF_LABELS = ['1DTrajectory', '2DArea', '3DMedium', 'Accompanier', 'Activity',
    ...
    'Locus', 'Manner', 'Material', 'Means', 'Other', 'Partitive', 'Patient',
    ...
    'Transit', 'Value', 'ValueComparison', 'Via', 'Whole', '`', '`d',
    '`i', '`a', '`j', '`o', '`r', '?'];
...
PSST_SHORT_DEFS = {
    ...
    "Accompanier": "Entity that another entity is together with. {along with, with, without}", 
    ...
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as per, depending on, despite, for, in, in accord with, in accordance with, in keeping with, in line with, in spite of, per, pursuant to, under, with}", 
    "ClockTimeCxn": "In constructions for telling time, the hour part. {after, of, past, to}", 
    "Co-Agent": "Participant acting symmetrically with the agent. {against, between, by, with}", 
    ...
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as if, as opposed to, beside, between, from, instead of, like, near, next to, of, rather than, than, to}", 
    ...
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, at, away, back, down, home, in, into, off, out, over, towards, up}", 
    "Donor/Speaker": "Animate starting point in a transfer scenario; counterpart to Recipient. {from}", 
    "Duration": "Temporal length of an event. {across, down, during, for, in, into, over, through}", 
    ...
    "Instrument": "Thing that enables or facilitates achieving some purpose. {at, with, without}", 
    "Location": "Concrete location. {about, above, across, against, all over, among, around, at, before, behind, below, beneath, beside, between, by, down, from, home, in, in front of, inside, inside of, near, next to, of, off, on, on top of, out of, outside, outside of, over, past, round, through, to, under, up, within, without}", 
    "Locus": "Abstract location. {among, at, below, in, on, within}", 
    ...
    "RelativeTime": "Time before or after some reference point. {after, before, between, by, past, since, towards}", 
    ...
    "Time": "Point in time. {around, as, at, for, in, near, on}", 
...
"of": {"Age": [6, "a boy of 15."], 
    ...
    "Species": [36, "One of the best types of ant to keep is the red ant .", "certain strains of Escherichia coli", "Modern breeds of these homing pigeons return reliably", "Some poor sap applied the wrong brand of paint"], 
...
"on": {"Activity": [3, "his attendant was out on errands."], 
    ...
    "Location": [565, "we got on the train.", "a scratch on her arm", "a smile on her face.", "an internment camp on the island", "the house on the corner.", "on the table was a water jug", "she was lying on the floor", "a sign on the front gate.", "put it on the table.", "John got some sleep on the plane.", "put your ideas down on paper"], 
    ...
    "Manner": [93, "soon the bird was strong enough to fly on its own"], 
...
PSST_TOP_LABELS = {"about": ["Topic", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    ...
    "as": ["Attribute", "`", "Time", "Explanation", "Circumstance"],
    ...
    "on": ["Location", "Topic", "State", "Manner", "Explanation", "Theme", "Goal", "Beneficiary", "Time", "Other", "Locus", "Via", "Activity", "Possessor", "ProfessionalAspect"],
