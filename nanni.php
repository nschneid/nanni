...
PSST_LIST_OF_LABELS = ['1DTrajectory', '2DArea', '3DMedium', 'Accompanier', 'Activity',
    ...
    'Co-Participant', 'Co-Patient', 'Co-Theme', 'Comparison/Contrast',
    'Contour', 'Course', 'Creator', 'DeicticTime', 'Destination',
    'Direction', 'Donor/Speaker', 'Duration', 'Elements', 'EndState',
    'EndTime', 'Experiencer', 'Explanation', 'Extent', 'Frequency',
    'Function', 'Goal', 'InitialLocation', 'Instance', 'Instrument',
    'Location', 'Locus', 'Manner', 'Material', 'Means', 'Patient',
    'Possessor', 'ProfessionalAspect', 'Purpose', 'Quantity',
    'Recipient', 'Reciprocation', 'RelativeTime', 'Scalar/Rank',
    'Source', 'Species', 'StartState', 'StartTime', 'State',
    'Stimulus', 'Superset', 'Temporal', 'Theme', 'Time', 'Topic',
    'Transit', 'Value', 'ValueComparison', 'Via', 'Whole'];
...
PSST_SHORT_DEFS = {
    ...
    "2DArea": "Two-dimensional area that is the location traversed. {about, all over, around, round, throughout}", 
    "3DMedium": "Three-dimensional medium that is traversed through. {through, with}", 
    "Accompanier": "Entity that another entity is together with. {along with, plus, together, together with, with, without}", 
    "Activity": "Action that an agent undertakes for a period of time. {at, in, into, on, up to, with}", 
    "Affector": "Abstract macro-role. {}", 
    "Age": "Something's age. {at, in, of}", 
    "Agent": "Animate/volitional/intentional instigator of an action. {by, of}", 
    "Approximator": "Measurement, quantity, or range being &quot;transformed&quot; by the preposition. {about, all of, around, at least, at most, between, circa, fewer than, just about, less than, like, minus, more than, over, plus, under}", 
    "Attribute": "Characteristic, feature, part, or possessum of an entity. {about, as, by, for, in, minus, of, with, without}", 
    "Beneficiary": "Animate or personified undergoer that is (potentially) advantaged or disadvantaged by the event or state. {against, by, for, on, to, towards, with}", 
    "Causer": "Force/party that precipitates an event (and is a central participant of it). {by, from, of, with}", 
    "Circumstance": "Macro-role. Used directly for occasions and contextualizations. {according to, as, as long as, as per, depending on, despite, for, in, in accord with, in accordance with, in keeping with, in line with, in spite of, per, pursuant to, regardless of, so long as, under, with, without}", 
    "ClockTimeCxn": "In constructions for telling time, the hour part. {after, of, past, to}", 
    "Co-Agent": "Participant acting symmetrically with the agent. {against, between, by, together, with}", 
    "Co-Participant": "Core participant portrayed as secondary. {with}", 
    "Co-Patient": "Undergoer symmetrical to the Patient. {between}", 
    "Co-Theme": "Undergoer symmetrical to the Theme. {between, for, from, to, with}", 
    "Comparison/Contrast": "Point of comparison, analogy, imitation, or contrast/distinction. {after, against, as, as if, as opposed to, as though, beside, between, from, instead of, like, more like, near, next to, of, rather than, than, to, unlike, versus}", 
    ...
    "Course": "Pathway used for travel. {by, down, through, up, via}", 
    "Creator": "Participant that has created something new. {by, of}", 
    "DeicticTime": "Earlier or later time expressed by the length of an interval relative to an implicit reference time. {ago, back, before, for, in, inside, to date, within}", 
    "Destination": "Endpoint (actual or intended) of physical motion. Excludes prepositions that also mark simple Locations. {for, into, onto, over, round, to, up to}", 
    "Direction": "Orientation or heading of a figure, without implying a specific starting or ending point of the path. {after, apart, at, away, back, back and forth, down, home, in, into, off, out, over, together, towards, up}", 
    "Donor/Speaker": "Animate starting point in a transfer scenario; counterpart to Recipient. {by, from}", 
    "Duration": "Temporal length of an event, or temporally overlapping reference event. {across, as long as, down, during, for, in, in the midst of, into, over, through, throughout}", 
    "Elements": "Member or non-member of a set of discrete items. {apart from, aside from, besides, beyond, but, except, except for, in addition to, like, minus, nothing but, of, on top of, other than, outside of, such as, with the exception of}", 
    "EndState": "Result of a change or endpoint of a range on a scale. {into, to}", 
    "EndTime": "When an event ends. {through, till, to, until, up to}", 
    "Experiencer": "Patient that is aware of the event undergone (specific to events of perception). {for, to}", 
    "Explanation": "Secondary event that is asserted as the reason for the main event. {after, as, because of, by virtue of, due to, for, on, on account of, out of, owing to, since, thanks to}", 
    "Extent": "Size of a path. {at, at all, by, for, of, through}", 
    "Frequency": "Temporal rate or repetitions. {after, at, by, for, over}", 
    "Function": "The function that an entity serves, or for which it was made. {by, for, to, towards}", 
    "Goal": "Abstract intended endpoint or outcome. {at, on, to, towards}", 
    "InitialLocation": "Locative origin or starting point of physical motion. {from, off, out of}", 
    "Instance": "''X '''of''' Y'', where ''X'' is a category that disambiguates or reframes (a more specific thing) ''Y''. {in, of}", 
    "Instrument": "Thing that enables or facilitates achieving some purpose. {at, on, with, without}", 
    "Location": "Concrete location. {about, above, across, against, ahead of, all over, among, apart, around, at, atop, away, back, before, behind, below, beneath, beside, between, beyond, by, down, downstairs, from, home, in, in front of, in the midst of, indoors, inside, inside of, near, nearby, next to, of, off, on, on top of, out, out of, outdoors, outside, outside of, over, past, round, through, throughout, to, under, up, upstairs, within, without}", 
    "Locus": "Abstract location. {among, at, before, below, in, on, within}", 
    "Manner": "How something happens. {by, in, on, with, without}", 
    "Material": "Ingredients/material from which something is made. {from, of, out of}", 
    "Means": "An activity that facilitates achieving some purpose. {by, through, via, with}", 
    "Participant": "Abstract macro-role. {}", 
    "Path": "Abstract region between an initial position and a final position. {}", 
    "Patient": "Undergoer in an event that experiences a change of state, location or condition, that is causally involved or directly affected by other participants, and exists independently of the event. {in, of, on, over, to}", 
    "Place": "Abstract macro-role. {}", 
    "Possessor": "Possessor of an entity (including kin) or attribute. {about, behind, of, on}", 
    "ProfessionalAspect": "Entity with which an individual is formally associated in a social/professional scenario such as employment or membership. {at, for, from, in, of, on, to, under, with}", 
    "Purpose": "Something that somebody wants to bring about. {for, in hopes of, in hopes to, to, with a view to, with an eye to, with an eye toward, with an eye towards}", 
    "Quantity": "X of Y, where Y is a category and X establishes how much of Y there is (or how many Ys there are). X may be an amount, collective noun, or measure phrase. {of}", 
    "Recipient": "Animate intended recipient of something concrete or abstract. Includes addressees. {at, for, to, with}", 
    "Reciprocation": "Action provoking a response/reaction (often judgment-laden, but not merely psychological) that is the main event. {for, to}", 
    "RelativeTime": "Time before or after some reference point. {after, afterward, ahead of, apart, before, beforehand, between, beyond, by, past, since, towards}", 
    "Scalar/Rank": "Point of comparison on a continuous or discrete scale (such as an ordering or ranking). {above, after, before, behind, below, beneath, beyond, for, next to, over, than, under}", 
    "Source": "Abstract starting point. {from, off, out of}", 
    "Species": "A category qualified by ''species'', ''breed'', ''kind'', ''type'', ''variety'', etc. {of}", 
    "StartState": "Initial state or beginning of a range on a scale. {from, out of}", 
    "StartTime": "Time an event begins. {from, since}", 
    "State": "State of affairs. {all over, around, at, beyond, down, in, in need of, in search of, in the middle of, in the midst of, near, off, on, out, out of, to, under, up, up to}", 
    "Stimulus": "That which is perceived or experienced (bodily, perceptually, or emotionally). {about, at, by, for, in, of, to, with}", 
    "Superset": "The object of the preposition is a set of discrete elements or mass quantity of which the governor is a member, subset, or sub-quantity. {among, from, in, of, out of, outside, within}", 
    "Temporal": "Macro-role for temporal characteristics. {by}", 
    "Theme": "Central undergoer that is not in control over the event, not structurally changed by the event, and/or is characterized as being in a certain position or condition. {for, from, in, of, on, to, with}", 
    "Time": "Point in time. {around, as, as soon as, at, circa, for, in, near, on}", 
    "Topic": "Information content in communication or &quot;high-level&quot; cognition. {about, around, as regards, as to, concerning, for, in, in terms of, into, of, on, over, re, regarding, round, towards, with}", 
    ...
    "Value": "Point on a formal scale. {at, by, for, in, into, of, per, to}", 
    "ValueComparison": "Value being compared to some other value on a scale. {above, below, near, up to}", 
    "Via": "Path/instrument that enables concrete or abstract entities (including information, etc.) to get from one place to another. {on, over, through, via}", 
...
PSST_LABELS = {"about": {"1DTrajectory": [18, "They skipped about my feet, a flock of lambs", "rotated 90 degrees clockwise about its lowest corner", "wrapped an arm about Emilia's shoulders"], 
    ...
    "Attribute": [949, "it's all about having fun"], 
    ...
    "Stimulus": [949, "I 'm still uncomfortable about the overall effect", "There was no excitement about my first bra", "There are only two possible grounds for worrying about the ownership of ICI : national security , and competition ."], 
    "Topic": [967, "I was thinking about you", "a book about ancient Greece", "I think that 's what I liked about growing up there ((ABOUT is headed by 'what', not 'liked'))", "there's nothing we can do about it."]},
...
"across": {"1DTrajectory": [469, "the bridge (that goes) across the river", "he looked across at me", "halfway across, Jenny jumped.", "I ran across the street", "travelling across Europe", "he had swum across."], 
    "Duration": [1, "Income inequality is known to persist across generations"], 
...
"after": {"ClockTimeCxn": [0, "I strolled in about ten minutes after two."], 
    ...
    "`": [18]},
"afterward": {"RelativeTime": [0, "I saw him before the play, but not afterward."]},
"against": {"Beneficiary": [21, "the first victim gave evidence against him."], 
    ...
    "Location": [124, "she stood with her back against the door", "frustration made him bang his head against the wall."]},
"ago": {"DeicticTime": [0, "Grandmother died a long time ago."]},
"ahead of": {"Location": [27, "Then a bit later there was this teeny tiny little woman walking ahead of me.", "But they believed they were protected by a front line of fighters ahead of them."], 
    "RelativeTime": [58, "It is now expected to be completed by October, two months ahead of its scheduled date."]},
"all of": {"Approximator": [0, "The first flight was late, so we had all of 15 minutes to make our connection."]},
...
"along with": {"Accompanier": [221, "There were two supermarket trolleys in the pond along with plastic bags and litter.", "When Charles was a boy he would inspect the troops along with his mother or grandmother."]},
...
"apart": {"Direction": [0, "Break the graham cracker apart"], 
    "Location": [0, "We live 3 miles apart"], 
    "RelativeTime": [0, "We were born 3 months apart"]},
...
"around": {"1DTrajectory": [161, "he put his arm around her.", "They zigzagged around tree trunks", "Lily peeped around the open curtain", "he walked around the airfield", "it can drill around corners."], 
    ...
    "State": [235, "I'll be around for another hour or so"], 
...
"as": {"Attribute": [257, "it came as a shock", "she got a job as a cook."], 
    "Circumstance": [0, "As expected, they won handily", "Here are the pictures as you requested", "As we read in chapter one of this book, the six days of creation starting in Genesis 1:2 are not the beginning of the world, but the renewal or recreation of the Earth for the second Heaven and Earth age"], 
    "Comparison/Contrast": [0, "As in the previous episode, the protagonist again must overcome one of his phobias."], 
...
"as if": {"Comparison/Contrast": [0, "He stared at me as if I were a ghost."]},
"as long as": {"Circumstance": [0, "You can borrow this, as long as you return it next week"], 
    "Duration": [0, "I've lived here (for) as long as you've been alive."]},
...
"as per": {"Circumstance": [0, "As per your instructions, I have enclosed an extra copy of my curriculum vitae."]},
...
"as soon as": {"Time": [0, "He canceled the project as soon as he became CEO."]},
"as though": {"Comparison/Contrast": [0, "He stared at me as though I were a ghost."]},
...
"at": {"Activity": [42, "boxing was the only sport I was any good at", "she was getting much better at hiding her reactions."], 
    ...
    "Extent": [0, "This won't cost more than $100 at the worst", "At least give me a chance"], 
    ...
    "Location": [445, "they live at Conway House", "they stopped at a small trattoria."], 
    ...
    "Recipient": [278, "He shouted something at Endill but he could n't hear because of the wind"], 
...
"at all": {"Extent": [0, "I don't like sports at all", "Are you at all hungry?"]},
"at least": {"Approximator": [0, "It will take at least an hour."]},
"at most": {"Approximator": [0, "It will take at most an hour."]},
"atop": {"Location": [51, "In an instant, she was no longer in a dungeon cell but atop a hill overlooking a valley."]},
"away": {"Direction": [0, "She swam away (from the shore).", "Charlie tried to grab the football but Lucy kicked it away.", "Lucy kicked the ball away from Charlie."], 
    "Location": [0, "The doctor is away.", "\"Peter Pan is away from home.\""]},
"back": {"DeicticTime": [0, "Back in the 1950s, computer input was printed on punch cards", "I saw that movie a while back"], 
    "Direction": [0, "She swam back (to the shore).", "The dog brought the ball back."], 
    "Location": [0, "The doctor is back."], 
    "`r": [0, "I'm now back in shape."]},
"back and forth": {"Direction": [0, "She swam back and forth along the length of the pool."]},
...
"before": {"DeicticTime": [36, "his playing days had ended six years before", "it's never happened to me before."], 
    ...
    "Locus": [9, "he could be taken before a magistrate for punishment."], 
...
"beforehand": {"RelativeTime": [0, "I saw him after the play, but not beforehand."]},
...
"below": {"Location": [27, "Most older houses will have a crawl space below the boards.", "A deep cut could penetrate to the fatty layer below the skin."], 
    "Locus": [18, "Please refer to the subsection below for details."], 
    "Scalar/Rank": [121, "Apollyon was his Second Lieutenant, ranking below only Lady Alysia and the Prince himself.", "There are countless examples of conduct by high profile sports stars that fall well below community standards."], 
...
"beyond": {"Elements": [0, "Beyond telling me to find new friends, Shelley was hinting that I was unattractive.", "They achieved nothing beyond deepening the passionate hatred of our country in those corners of the globe."], 
    "Location": [0, "There was one handhold but it was a few inches beyond my reach.", "Behind the cabin was a large empty yard"], 
    "RelativeTime": [11, "Screening continued beyond midnight"], 
    "Scalar/Rank": [0, "And it was true that the exhausting task we had set ourselves was in some ways far beyond what ordinary rickshaw drivers ever attempted.", "A few of us decided to get together and try and raise money above and beyond what people had already kindly donated.", "You are also exhibiting obesity beyond the legal limit.", "The staff was beyond impeccable"], 
    "State": [0, "Land and water resources are stretched beyond limits due to our burgeoning population."]},
...
"by": {"1DTrajectory": [0, "I drove by our house."], 
    ...
    "Donor/Speaker": [0, "anything you do is all right by me"], 
...
"circa": {"Approximator": [0, "The ancient church dates to circa 1000 A.D."], 
    "Time": [0, "We arrived at 5 and left circa 7."]},
"concerning": {"Topic": [250, "He writes extensively on subjects concerning cross-strait relations and Chinese politics."]},
"depending on": {"Circumstance": [242, "They were given an allowance depending on their need and what was available"]},
"despite": {"Circumstance": [250, "I've never really been one for graphs and charts, despite being a bit of a maths geek."]},
"down": {"1DTrajectory": [230, "up and down the stairs", "tears streaming down her face."], 
    ...
    "Direction": [0, "The bird flew down from the tree.", "Lucy threw the ball down (to the ground)."], 
    "Duration": [0, "astrologers down the ages."], 
    "Location": [254, "she was tired of going down the pub every night.", "I often see him down the pub", "(he lives) a dozen miles or so down the Thames", "he lived down the street"], 
    "State": [0, "The NASDAQ was down an hour before the closing bell", "The servers are down", "I am feeling down today"]},
"downstairs": {"Location": [0, "The kids are downstairs."]},
...
"fewer than": {"Approximator": [0, "In this version of the story there are fewer than 4 Horsemen of the Apocalypse."]},
"for": {"Attribute": [381, "the ride screens children for height"], 
    "Beneficiary": [337, "Eating healthy food is good/expensive/important for students ((semantically, adj. takes a predicate AND a participant as arguments))", "troops who had fought for Napoleon", "the High Court found for the Commissioner", "I got a present for you", "these parents aren't speaking for everyone."], 
    ...
    "Function": [395, "the \"F\" is for Fascinating.", "networks for the exchange of information", "a great night for a party", "It's time for new leadership", "a coupon for peanut butter"], 
    "ProfessionalAspect": [28, "she is a tutor for the Open University."], 
    "Purpose": [766, "Blackbeard seemed ready to murder us for a wallet with a few fivers in it", "I went to the store for eggs", "We hired a caterer for the party", "physical therapy for a leg injury", "the necessary tools for making a picture frame."], 
    "Recipient": [133, "I see your ladyship has no very important commands for me"], 
    ...
    "Stimulus": [133, "admiration for Sarah", "appreciation for alliteration", "contempt for dull issues like club discipline"], 
    "Theme": [575, "the demand for money", "she is responsible for the efficient running of their department", "setting minimum prices for Japanese memory chips sold in Europe", "We will do it to express our derision for this Treasury bench of limpets ((speech act))", "you have a great desire for solitude", "charge higher prices for goods bought by credit card", "Sheldukher fumbled for his laser pistol", "phone for a taxi", "be undeterred in your search for the possible dream"], 
...
"from": {"Causer": [71, "a child suffering from (= afflicted with/by) asthma.", "die from cancer"], 
    "Co-Theme": [351, "estranged from their families"], 
    "Comparison/Contrast": [26, "anything from geography to literature.", "they are the subject-matter of most stories and novels from Pooh to Proust", "these fees are quite distinct from expenses."], 
    ...
    "ProfessionalAspect": [539, "take lessons from John", "Mary from human resources"], 
    "Source": [731, "information obtained from papers, books, and presentations.", "I had a manicure from Rachel", "We got terrible service from this restaurant", "someone I know from work", "everyone is from the same team", "the representative from my district", "men who ranged in age from seventeen to eighty-four."], 
    ...
    "Superset": [430, "there are several options to choose from"], 
    "Theme": [11, "the story of how he was saved from death.", "The agents preventing activists from boarding planes were assisted by the airlines.", "Thus the women of Cyrene abstained from veal", "campaign to protect the trees from a surprise attack by council workmen"]},
"home": {"Direction": [0, "She flew home to Boston."], 
    "Location": [0, "She stayed home"]},
"in": {"Activity": [542, "many scientists were involved in putting a man on the moon", "they were prompt in their response"], 
    "Age": [142, "a woman in her thirties."], 
    ...
    "Circumstance": [16, "In announcing the program, Computershare pointed out the environmental benefits of reducing the use of valuable resources such as trees.", "He was unsuccessful in running for president"], 
    ...
    "Direction": [0, "The bird flew in (=inside).", "cover the well so Timmy won't fall in", "the fog rolled in (from the sea) overnight", "the boat drifted in toward the shore", "hold your stomach in"], 
    "Duration": [0, "John was here in 45 minutes after I called"], 
    "Instance": [0, "You've got a friend in me.", "He's met his match in her."], 
    "Location": [1019, "I'm living in London", "she saw the bus in the rear-view mirror.", "\"Put it in a box and mark it 'fra-gilee'.\"", "don't put coal in the bath", "he got in his car and drove off.", "The doctor is in."], 
    ...
    "Theme": [768, "\"I'm covered in bees!\""], 
    "Time": [98, "they met in 1885", "at one o'clock in the morning", "In my life I have never seen so many cats on a couch", "the leaders met for the 8th time in 6 weeks"], 
    "Topic": [211, "an increased public interest in issues of defence , disarmament and peace"], 
    "Value": [0, "a local income tax running at six pence in the pound."]},
"in accord with": {"Circumstance": [109, "staff members are acting in accord with procedure", "To be truly fashionable, the union argued, clothing had to be produced in accord with standards of decency."]},
"in accordance with": {"Circumstance": [0, "Personal data shall be processed in accordance with the rights of data subjects under this Act."]},
...
"in hopes of": {"Purpose": [0, "I bought a lottery ticket in hopes of retiring early."]},
"in hopes to": {"Purpose": [0, "I bought a lottery ticket in hopes to retire early."]},
"in keeping with": {"Circumstance": [0, "This is a noble sentiment and entirely in keeping with the true spirit of the Olympics."]},
"in line with": {"Circumstance": [236, "This has been our policy for some time and is in line with most other train companies' policies.", "It is boosting production of its malaria drug in line with sharply increased demand."]},
...
"in search of": {"State": [0, "I went to several stores in search of a nice pair of slippers."]},
"in spite of": {"Circumstance": [250, "Leila had known it was a good idea to get a gardener, in spite of what others said."]},
"in terms of": {"Topic": [250, "In terms of diversity, students said they had more opportunities to talk with students who had different backgrounds."]},
"in the middle of": {"State": [0, "I'm in the middle of a bath, so you'll have to wait."]},
"in the midst of": {"Duration": [89, "Nithard wrote in the midst of war ."], 
    "Location": [42, "It is not in the midst of the town , but a little way to the west , on the river-bank .", "another who is standing in the midst of the dancers"], 
    "State": [89, "Elsewhere he renewed his contacts with Bishop Jocelin of Wells , then in the midst of rebuilding the cathedral church in Wells ."]},
"indoors": {"Location": [0, "The kids are indoors."]},
"inside": {"DeicticTime": [0, "the oven will have paid for itself inside 18 months."], 
    "Location": [86, "he went inside Graves and scored near the post.", "a radio was playing inside the flat", "Mr Jackson is waiting for you inside.", "Anatoly reached inside his shirt and brought out a map", "we walked inside."]},
"inside of": {"Location": [17, "They had never told us they were going to build a studio inside of our house.", "\"Outside of a dog, a book is a man's best friend. Inside of a dog it's too dark to read.\""]},
...
"just about": {"Approximator": [0, "the project is just about done", "\"I've had just about enough of this. That parrot is definitely deceased.\""]},
"less than": {"Approximator": [0, "In this version of the story there are less than 4 Horsemen of the Apocalypse."]},
"like": {"Approximator": [0, "It cost like $10."], 
    "Comparison/Contrast": [366, "he used to have a car like mine", "they were like brothers", "she looked nothing like Audrey Hepburn.", "he was screaming like a banshee.", "students were angry at being treated like children.", "It seems like the proposal encountered objections from management", "I feel like I ate a cow"], 
    "Elements": [2, "the cautionary vision of works like Animal Farm and 1984."], 
    "`d": [0, "He is, like, the biggest bully."]},
"minus": {"Approximator": [5, "Bills for winter heating came to 200 for gas during a particularly cold month last year when temperatures dropped below minus 20 degrees."], 
    "Attribute": [65, "I decided on the outfit Mattie had made me wear while we were in Florida. minus the shorts.", "Eventually he was given the machine back, minus its disc - which had apparently been destroyed."], 
    "Elements": [65, "all the Rumanians now living in Austria and Turkey (minus Rumanian Jews)"]},
"more like": {"Comparison/Contrast": [0, "Shops were empty from panic-buying ahead of Czechoslovakia 's ` big bang ' -- which is turning out to be more like a big pop .", "This would not be a case of losing valuable seconds to get to the fire but more like quite a few minutes.", "The Toronto Star, the Globe, the Post, and even the CBC were saying 15,000 protestors, when the day-to-day estimates were more like 60,000 to 80,000."]},
"more than": {"Approximator": [0, "In this version of the story there are more than 4 Horsemen of the Apocalypse."]},
...
"nearby": {"Location": [0, "He lives nearby.", "He lives in a nearby town.", "The thresh machine was put up on the first peanut field and then nearby the farm house"]},
"next to": {"Comparison/Contrast": [0, "Compared with Spain it is garbage, next to Italy it is humble and alongside Germany it stands as an equal."], 
    "Location": [0, "Position this next to a north facing window"], 
    "Scalar/Rank": [0, "Purchasing a vehicle is the second biggest purchase a woman is likely to make next to buying a home."]},
"nothing but": {"Elements": [0, "\"I have nothing but contempt for these people.\""]},
"of": {"Age": [6, "a boy of 15."], 
    "Agent": [273, "the decision of the County Council."], 
    ...
    "Comparison/Contrast": [0, "I'm more of a baseball fan than a soccer fan"], 
    ...
    "Instance": [559, "the city of Prague", "the idea/task/hassle of opening a new business", "the topic/issue of semantics", "my misfortune of ordering the wrong things"], 
    "Location": [0, "north of Watford.", "within spitting distance of the saloon"], 
    "Material": [86, "the house was built of bricks", "walls of stone."], 
    "Patient": [909, "the murder of two boys"], 
    "Possessor": [1208, "it was kind of you to ask", "the son of a friend", "the government of India", "The smug foolishness of the Western leaders was typified by the British participants.", "What was the time of the party?", "the opinion of the directors"], 
    "ProfessionalAspect": [775, "a former colleague of John's.", "members of the board"], 
    "Quantity": [1222, "a bag of popcorn", "a group of people wearing hats", "She has a lot of charm", "a sheet of paper"], 
    "Species": [36, "One of the best types of ant to keep is the red ant .", "certain strains of Escherichia coli", "Modern breeds of these homing pigeons return reliably", "Some poor sap applied the wrong brand of paint", "This store offers a wide selection of footstools"], 
    "Stimulus": [67, "fear of bears", "proud of our accomplishments"], 
    "Superset": [1135, "nine/all/lots/a bunch of the students in the class came to the show", "10% of American men are left-handed", "hundreds of dollars", "Some of the carbon dioxide has leaked", "the days of the week."], 
    "Theme": [1000, "payment of his debts", "He cleared it of leaves ((removal verbs))"], 
    ...
    "Whole": [1135, "a third/none of the pie is left", "the sleeve of his coat", "in the back of the car", "the headquarters of the company", "the last hour of the game"]},
...
"on": {"Activity": [3, "his attendant was out on errands."], 
    ...
    "Explanation": [93, "We went to war on bad intelligence"], 
    "Goal": [86, "five air raids on Schweinfurt", "thousands marching on Washington", "her eyes were fixed on his dark profile."], 
    "Instrument": [41, "The horse reared back on its hind legs"], 
    "Location": [606, "we got on the train.", "a scratch on her arm", "a smile on her face.", "an internment camp on the island", "the house on the corner.", "on the table was a water jug", "she was lying on the floor", "a sign on the front gate.", "put it on the table.", "she kissed me on the cheek", "John got some sleep on the plane.", "put your ideas down on paper"], 
    "Locus": [30, "he was on his way to see his mother.", "we met on a trip/vacation/journey/expedition/mission to Paris", "stored on the client's own computer.", "charge it on my credit card"], 
    "Manner": [134, "soon the bird was strong enough to fly on its own", "he was lying on his back.", "the box fell on its side"], 
    "Patient": [86, "the mechanic worked on the engine", "nosh on snacks"], 
    "Possessor": [1, "she only had a few pounds on her.", "that outfit looks good on you"], 
    "ProfessionalAspect": [0, "they would be allowed to serve on committees."], 
    "State": [99, "You're on your own.", "he is on morphine to relieve the pain."], 
    "Theme": [86, "spend a lot of money on textbooks"], 
...
"onto": {"Destination": [175, "Survivors ran screaming onto the street", "It is only dangerous if you attempt to climb up onto the wall", "I got onto the train to go home.", "a small strip of tape designed to stick firmly onto skin"]},
"other than": {"Elements": [0, "Site owners with a primary language other than English need efficient English copy writers and editors."]},
"out": {"Direction": [0, "With this weather, it isn't safe to go out (=outside).", "I put a nickel into the machine and a gumball came out.", "He took a good drag off the Arturo Fuente and let the smoke waft out from between pursed lips."], 
    "Location": [0, "\"He should not be here / when your mother is out!\"", "He lives out in the boonies", "I've always wanted to move out West"], 
    "State": [0, "Yer out!", "the light is out"]},
"out of": {"1DTrajectory": [0, "He climbed back out of the window"], 
    "Explanation": [2, "Police have said he acted out of spite", "He said he was motivated to find his son's attackers not out of revenge but to get justice for Daniel"], 
    ...
    "Material": [0, "Fashioned out of rich black walnut, the chair is as much art as it is furniture."], 
    "Source": [0, "If that alone was the only benefit they got out of the lesson, then you would say it was very worthwhile.", "Pensioners like us have paid into the NHS all our lives and we should not have to pay for treatment out of our savings."], 
    "StartState": [0, "She was fresh out of college and looking for a job"], 
    "State": [0, "My guess is that it was never released over here, so I may be out of luck.", "It would appear that we're out of gas.", "they stayed out of sight", "the lift is out of order"], 
...
"outdoors": {"Location": [0, "The kids are outdoors."]},
"outside": {"Location": [0, "The only home score came when full-back Leigh Hinton came up outside his winger to make the extra man.", "The same boy is standing outside a school waiting to be collected.", "He was running towards a little boy outside an open door, down the hall.", "I should have said that all the kids who either went into the sewer or stood outside the sewer were boys.", "My friend had a car stolen by a gang of boys outside Starbucks.", "The crowd was now situated right outside her door, with the Duke's coach not too far away."], 
    "Superset": [0, "She warmly thanked the many members both in and outside the committee who have given sterling service over the year.", "This is an experience that cannot be replicated outside a university or something at least akin to it."]},
"outside of": {"Elements": [0, "He accepts that, outside of a handful of top flight clubs, few will have his take-home pay.", "It dawned on me that we hadn't actually sat opposite each other outside of a scene from the play before then.", "\"Outside of a dog, a book is a man's best friend. Inside of a dog it's too dark to read.\""], 
    "Location": [0, "I saw all the commotion outside of your house and I didn't know what happened.", "I don't ever want to step outside of his classroom, so I'll go wherever he goes."]},
"over": {"1DTrajectory": [56, "he toppled over the side of the boat.", "she trudged over the lawn.", "glance over her shoulder"], 
    ...
    "Direction": [0, "We often walk over on Saturdays."], 
    "Duration": [4, "you've given us a lot of heartache over the years", "she told me over coffee."], 
    "Frequency": [0, "If you fail you may take the test over."], 
    "Location": [115, "I saw flames over Berlin", "cook the sauce over a moderate heat.", "over the hill is a small village.", "his flat was over the shop.", "an oxygen tent over the bed", "ladle this sauce over fresh pasta.", "views over Hyde Park.", "The horses are grazing over by the farmhouse."], 
...
"per": {"Circumstance": [0, "Per your instructions, I have enclosed an extra copy of my curriculum vitae."], 
    "Value": [243, "the cost of repainting was expressed in terms of a rate per square metre."]},
"plus": {"Accompanier": [157, "The townhouse comprises 18 main rooms plus a kitchen"], 
    "Approximator": [0, "Mornings would see me waking to my fancy alarm clock's digital readout of a temperature of a tooth-chattering plus three Celsius.", "The repairs will take a week plus."]},
"pursuant to": {"Circumstance": [0, "Likewise, an application under Part 32.14, is made pursuant to and in accordance with the Civil Procedure Rules."]},
"rather than": {"Comparison/Contrast": [0, "I want soup rather than salad"]},
"re": {"Topic": [14]},
"regarding": {"Topic": [209, "He raised several concerns regarding the proposed tuition hikes"]},
"regardless of": {"Circumstance": [250, "Acne can affect men and women of all ages regardless of skin type or lifestyle.", "Both councillors said regardless of the signs in place, people did not always follow them."]},
...
"since": {"Explanation": [0, "Since you like animal movies, let's watch 'Ratatouille'."], 
    "RelativeTime": [242, "It was the British who suffered the worst single incident since the end of the war."], 
...
"so long as": {"Circumstance": [0, "You can borrow this, so long as you return it next week"]},
"such as": {"Elements": [0, "institutions such as the family and marriage"]},
"than": {"Comparison/Contrast": [0, "we would rather be able to see than be blind", "the show was different than what I expected", "the musical was more Cole Porter than Gilbert and Sullivan"], 
    "Scalar/Rank": [0, "Our council tax is much higher than in larger towns", "we hope to register even more participants than last year.", "It turned out to be better in looks than taste", "everything is worse than it was", "The sight was far less dismaying than the thought of going out of the house .", "He likes getting in on the act too and has appeared in more productions than he cares to count.", "On one occasion a female passenger leaned on him for more than just a friendly chat."]},
...
"throughout": {"2DArea": [87, "Before long the story spread throughout the city of the crazy man who had purchased a dream."], 
    "Duration": [113, "Trained personal advisors will be on standby throughout the exam results period."], 
    "Location": [87, "He also pointed out that wandering dogs did a lot of damage to sheep throughout the country.", "The severe heat has resulted in a record number of deaths throughout the East Coast."]},
"till": {"EndTime": [0]},
"to": {"Beneficiary": [703, "you were terribly unkind to her", "priced to be affordable to domestic users", "She was rude to Larry Hagman"], 
    ...
    "Comparison/Contrast": [0, "the club's nothing to what it once was.", "they are the subject-matter of most stories and novels from Pooh to Proust"], 
    "Destination": [587, "walking down to the shops", "my first visit to Africa.", "every driveway to the castle was crowded", "emigrants to South Africa"], 
    "EndState": [160, "Christopher's expression changed from amazement to joy", "she was close to tears.", "they spiced the soup to my liking", "smashed to smithereens.", "a drop in profits from \u00a3105 m to around \u00a375 m", "to her astonishment, he smiled."], 
    "EndTime": [0, "from 1938 to 1945."], 
    "Experiencer": [132, "speed altogether surprising to Miss Buckley"], 
    "Function": [0, "a shoulder to cry on", "a reason to live", "a good person to work with"], 
    "Goal": [571, "charge it to my credit card"], 
    "Location": [8, "(He lives) forty miles to the south of the site", "place the cursor to the left of the first word."], 
    ...
    "Recipient": [571, "John told the news to Mary", "they donated \u00a3400 to the hospice."], 
    "Reciprocation": [112, "an answer to the question", "India's swift reaction to the \"provocation\" by Pakistan"], 
    "State": [2, "the order was to our satisfaction"], 
    "Stimulus": [112, "listen to the music"], 
    ...
    "`d": [0, "To be honest, I thought this book was boring."], 
    "`i": [0, "I want to suck your blood", "To win is my greatest desire", "I am happy to meet you halfway", "It took them 2 hours to finish the repairs", "She always takes the time to mentor her students"]},
"to date": {"DeicticTime": [0, "To date, nobody has returned my calls."]},
"together": {"Accompanier": [0, "The cats are together on the windowsill"], 
    "Co-Agent": [0, "Jim and I enjoy doing business together"], 
    "Direction": [0, "Bring the pieces together"]},
"together with": {"Accompanier": [225, "One of the older girls brought in tea together with the rich fruit cake on a plate."]},
...
"under": {"Approximator": [0, "Jacques Chirac, the right wing president, scraped just under 20 percent of the vote.", "The majority of cases in Angola have occurred in children under the age of five years.", "Which meant if I ran the second half at the same speed I would have finished in under four hours."], 
    "Circumstance": [0, "All four youths were arrested under the Explosives Act and taken to Fulford Police Station."], 
    "Location": [0, "Pity the display was directly under the departures board which had a long list of delayed and cancelled trains.", "Richey is looking forward to experiencing the things we take for granted, such as feeling grass under his feet.", "I had three layers on under my thick winter coat.", "He recently began to put gold and silver metal leaf under the paint", "Another had lain on a chaise lounge for four days, his stockinged feet poking out from under a quilt.", "Fruit cell turgors were obtained by probing the mesocarp cells directly under the fruit epidermis.", "The cat thought it was great fun and climbed under the duvet with me.", "He landed in an old storage room somewhere under the museum, where he was he had no idea.", "Dropping forward onto the walkway around the hold it is possible to swim into the crew's quarters under the chart room.", "The luggage compartment floor is on two levels, under which the rear seat base can be stowed."], 
...
"up": {"1DTrajectory": [0, "She pushed her glasses further up the bridge of her nose.", "I don't know where we were, but I wanted to climb up a really steep hill - which seemed to take ages.", "We picked our way up one side of the ridge, and I found a spot where we could spend the long night ahead.", "She shrieked with laughter as they raced up the stairs.", "Calleri is one of several Argentines moving steadily up the rankings."], 
    ...
    "Direction": [0, "The bird flew up into the tree.", "Lucy tossed the ball up (in the air)."], 
    "Location": [1, "Gould 's brother-in-law 's station , 160 miles from Newcastle on the coast up the Hunter River at Yarrundi , far exceeded Gould 's expectations both in size and in beauty .", "I lived just up the street from them.", "Then we went up the pub and stayed there until midnight.", "Fancy going up the shops?", "He was such a lovely lad, would often see him up the pub"], 
    "State": [0, "Is he up yet, or still sleeping?", "The NASDAQ was up an hour before the closing bell", "The servers are back up", "I am feeling up today"]},
"up to": {"Activity": [0, "I wonder what he's up to ?", "A real poker player would quickly realize what you were up to and stop falling for it."], 
    "Destination": [0, "The flood water reached up to the middle of the car wheels", "the ice gave way, plunging Luke into the water up to his waist.", "The shutters were firmly closed, but, as in many old houses, they did not reach right up to the very top of the window."], 
    "EndTime": [16, "If we have survived up to now what is stopping us from surviving in the future?"], 
    "State": [0, "The choice of grid is up to the artist, as is the color of each of the grid's cells.", "But is it the government's duty, or is it up to individuals to take responsibility for their eating?", "Mentally I was not up to the challenge of traveling to Australia.", "I wasn't feeling up to going out, so I spent quite a bit of time listening to music.", "He's good at speeches, and this one was up to his usual standard."], 
    "ValueComparison": [41, "The Board have offered to make a contribution to our cost up to a maximum of $50,000."]},
"upstairs": {"Location": [0, "The kids are upstairs."]},
"versus": {"Comparison/Contrast": [0, "More detailed studies are needed on the costs of rural versus urban car usage."]},
...
"with": {"3DMedium": [0, "marine mammals generally swim with the current."], 
    "Accompanier": [274, "a nice steak with a bottle of red wine.", "Boris still lives with his parents"], 
    "Activity": [286, "Matilda was great with maths"], 
    ...
    "Co-Participant": [274, "He shares a last name with me"], 
    "Co-Theme": [286, "continued supply of arms to one side is incompatible with neutrality", "replace the old tires with new ones", "they confused my order with someone else's"], 
    ...
    "Recipient": [286, "Jairus pleaded with Jesus to cure his twelve-year-old daughter", "I tried to reason with her"], 
    "Stimulus": [146, "he was trembling with fear.", "the teacher was unhappy with the student's work", "We had a terrible experience with Comcast"], 
    "Theme": [717, "\"The tail I could live with, but the fleas\u2014they're murder!\"", "Faith was done with old-fashioned equipment", "fill the bowl with water."], 
    "Topic": [303, "He is familiar with the property market", "Irina had been brisk when she called with the news and told him to telephone Rakovsky at his hotel ."]},
"with a view to": {"Purpose": [0, "I bought a lottery ticket with a view to retire early."]},
"with an eye to": {"Purpose": [0, "I bought a lottery ticket with an eye to retire early."]},
"with an eye toward": {"Purpose": [0, "I bought a lottery ticket with an eye toward early retirement."]},
"with an eye towards": {"Purpose": [0, "I bought a lottery ticket with an eye towards early retirement."]},
"with the exception of": {"Elements": [250, "Everyone at the meeting with the exception of one was in agreement.", "The two teams were on their feet for the best part of two and a half hours, with the exception of the interval break."]},
"within": {"DeicticTime": [38, "The first show sold out within hours of tickets going on sale."], 
    "Location": [15, "Good to see a local hangout that's within staggering distance home if you're totally mangled.", "Mr Bradbury said people should know better than to start any sort of fire within a forest", "The plan states that new retail development is most suitably located within the city centre.", "The Slieve Bloom mountains and a number of forest parks are within easy reach."], 
    "Locus": [0, "Language evolves but, necessarily, within the bounds of shared comprehension."], 
    "Superset": [4, "However, appointing Milburn may well be the spark that lights the fire of civil war within the Party.", "For the next hundred years, the argument would be within the centre-left"]},
"without": {"Accompanier": [0, "Others never venture into the outside world without a chaperone."], 
    "Attribute": [0, "True, it is hard to live without the comforts of this world.", "The risk of death in a house fire is three times higher in homes without smoke alarms."], 
    "Circumstance": [0, "I got put on hold twice without saying a word"], 
    "Instrument": [0, "They have to light a fire without matches"], 
    "Location": [0], 
    "Manner": [0, "a magic man who walks through fire without being burned.", "It is very sad that these people can't manage an hour or so without smoking."]}
};
...
PSST_TOP_LABELS = {"about": ["Topic", "Stimulus", "Attribute", "2DArea", "1DTrajectory", "Possessor", "Location", "Approximator"],
    "above": ["Location", "Scalar/Rank", "ValueComparison", "1DTrajectory"],
    "according to": ["`d", "Circumstance"],
    ...
    "afterward": ["RelativeTime"],
    "against": ["Location", "Beneficiary", "Co-Agent", "Comparison/Contrast"],
    "ago": ["DeicticTime"],
    "ahead of": ["RelativeTime", "Location"],
    "all of": ["Approximator"],
    "all over": ["State", "Location", "2DArea"],
    "along": ["1DTrajectory"],
    "along with": ["Accompanier"],
    "among": ["Locus", "Location", "Superset"],
    "apart": ["RelativeTime", "Location", "Direction"],
    "apart from": ["Elements"],
    "around": ["State", "2DArea", "1DTrajectory", "Location", "Time", "Topic", "Approximator"],
    "as": ["Attribute", "`", "Time", "Explanation", "Comparison/Contrast", "Circumstance"],
    "as if": ["Comparison/Contrast"],
    "as long as": ["Duration", "Circumstance"],
    "as opposed to": ["Comparison/Contrast"],
    "as per": ["Circumstance"],
    "as regards": ["Topic"],
    "as soon as": ["Time"],
    "as though": ["Comparison/Contrast"],
    "as to": ["Topic"],
    "aside from": ["Elements"],
    "at": ["Location", "Recipient", "Goal", "Stimulus", "Value", "Frequency", "Time", "Activity", "Direction", "Instrument", "State", "Age", "ProfessionalAspect", "Locus", "Extent"],
    "at all": ["Extent"],
    "at least": ["Approximator"],
    "at most": ["Approximator"],
    "atop": ["Location"],
    "away": ["Location", "Direction"],
    "back": ["`r", "Location", "Direction", "DeicticTime"],
    "back and forth": ["Direction"],
    "because of": ["Explanation"],
    "before": ["RelativeTime", "DeicticTime", "Location", "Locus", "Scalar/Rank"],
    "beforehand": ["RelativeTime"],
    "behind": ["Location", "Scalar/Rank", "Possessor"],
    "below": ["Scalar/Rank", "ValueComparison", "Location", "Locus"],
    ...
    "beyond": ["RelativeTime", "State", "Scalar/Rank", "Location", "Elements"],
    "but": ["Elements"],
    "by": ["Agent", "Means", "Stimulus", "Causer", "Extent", "Creator", "Location", "Transit", "Course", "Attribute", "Function", "Temporal", "RelativeTime", "Value", "Manner", "Frequency", "Donor/Speaker", "Co-Agent", "Beneficiary", "1DTrajectory"],
    "by virtue of": ["Explanation"],
    "circa": ["Time", "Approximator"],
    "concerning": ["Topic"],
    "depending on": ["Circumstance"],
    "despite": ["Circumstance"],
    "down": ["Location", "Course", "1DTrajectory", "State", "Duration", "Direction"],
    "downstairs": ["Location"],
    "due to": ["Explanation"],
    "during": ["Duration"],
    "except": ["Elements"],
    "except for": ["Elements"],
    "fewer than": ["Approximator"],
    "for": ["Purpose", "Theme", "Function", "Reciprocation", "Explanation", "Circumstance", "Attribute", "Beneficiary", "Experiencer", "`", "Stimulus", "Recipient", "Duration", "DeicticTime", "Topic", "Scalar/Rank", "ProfessionalAspect", "Value", "Co-Theme", "Time", "Destination", "Frequency", "Extent"],
    "from": ["InitialLocation", "StartState", "Source", "Donor/Speaker", "ProfessionalAspect", "Location", "Superset", "Co-Theme", "Causer", "Comparison/Contrast", "Material", "StartTime", "Theme"],
    "home": ["Location", "Direction"],
    "in": ["Location", "Theme", "Activity", "Superset", "Locus", "Attribute", "Topic", "Stimulus", "Patient", "State", "Age", "Manner", "Contour", "DeicticTime", "Time", "ProfessionalAspect", "Circumstance", "Value", "Instance", "Duration", "Direction"],
    "in accord with": ["Circumstance"],
    "in accordance with": ["Circumstance"],
    "in addition to": ["Elements"],
    "in front of": ["Location"],
    "in hopes of": ["Purpose"],
    "in hopes to": ["Purpose"],
    "in keeping with": ["Circumstance"],
    "in line with": ["Circumstance"],
    "in need of": ["State"],
    "in search of": ["State"],
    "in spite of": ["Circumstance"],
    "in terms of": ["Topic"],
    "in the middle of": ["State"],
    "in the midst of": ["State", "Duration", "Location"],
    "indoors": ["Location"],
    "inside": ["Location", "DeicticTime"],
    "inside of": ["Location"],
    "instead of": ["Comparison/Contrast"],
    "into": ["Destination", "EndState", "Direction", "Topic", "Duration", "Value", "Activity"],
    "just about": ["Approximator"],
    "less than": ["Approximator"],
    "like": ["Comparison/Contrast", "Elements", "`d", "Approximator"],
    "minus": ["Elements", "Attribute", "Approximator"],
    "more like": ["Comparison/Contrast"],
    "more than": ["Approximator"],
    "near": ["Location", "Time", "ValueComparison", "State", "Comparison/Contrast"],
    "nearby": ["Location"],
    "next to": ["Scalar/Rank", "Location", "Comparison/Contrast"],
    "nothing but": ["Elements"],
    "of": ["Quantity", "Possessor", "Whole", "Superset", "Topic", "Theme", "Patient", "ProfessionalAspect", "Instance", "Agent", "Material", "Elements", "Stimulus", "Causer", "Species", "Attribute", "Creator", "Value", "Extent", "Age", "Location", "Comparison/Contrast", "ClockTimeCxn"],
    "off": ["InitialLocation", "Source", "Direction", "Location", "State"],
    "on": ["Location", "Topic", "Manner", "State", "Explanation", "Theme", "Patient", "Goal", "Beneficiary", "Time", "Instrument", "Locus", "Via", "Activity", "Possessor", "ProfessionalAspect"],
    "on account of": ["Explanation"],
    "on top of": ["Location", "Elements"],
    "onto": ["Destination"],
    "other than": ["Elements"],
    "out": ["State", "Location", "Direction"],
    "out of": ["Superset", "Explanation", "State", "StartState", "Source", "Material", "Location", "InitialLocation", "1DTrajectory"],
    "outdoors": ["Location"],
    "outside": ["Superset", "Location"],
    "outside of": ["Location", "Elements"],
    "over": ["Location", "Topic", "1DTrajectory", "Patient", "Duration", "Destination", "Scalar/Rank", "Via", "Frequency", "Direction", "Approximator"],
    "owing to": ["Explanation"],
    "past": ["1DTrajectory", "RelativeTime", "ClockTimeCxn", "Location"],
    "per": ["Value", "Circumstance"],
    "plus": ["Accompanier", "Approximator"],
    "pursuant to": ["Circumstance"],
    "rather than": ["Comparison/Contrast"],
    "re": ["Topic"],
    "regarding": ["Topic"],
    "regardless of": ["Circumstance"],
    "round": ["1DTrajectory", "Location", "2DArea", "Topic", "Destination"],
    "since": ["StartTime", "RelativeTime", "Explanation"],
    "so long as": ["Circumstance"],
    "such as": ["Elements"],
    "than": ["Scalar/Rank", "Comparison/Contrast"],
    "thanks to": ["Explanation"],
    "through": ["1DTrajectory", "3DMedium", "Course", "Via", "Means", "Location", "Duration", "Extent", "EndTime"],
    "throughout": ["Duration", "Location", "2DArea"],
    "till": ["EndTime"],
    "to": ["Beneficiary", "Destination", "Recipient", "Goal", "EndState", "Co-Theme", "Patient", "Experiencer", "Theme", "Stimulus", "Reciprocation", "ProfessionalAspect", "Location", "State", "`i", "`d", "Value", "Purpose", "Function", "EndTime", "Comparison/Contrast", "ClockTimeCxn"],
    "to date": ["DeicticTime"],
    "together": ["Direction", "Co-Agent", "Accompanier"],
    "together with": ["Accompanier"],
    "towards": ["Direction", "Topic", "Beneficiary", "Goal", "RelativeTime", "Function"],
    "under": ["State", "Scalar/Rank", "ProfessionalAspect", "Location", "Circumstance", "Approximator"],
    "unlike": ["Comparison/Contrast"],
    "until": ["EndTime"],
    "up": ["Location", "Course", "State", "Direction", "1DTrajectory"],
    "up to": ["ValueComparison", "EndTime", "State", "Destination", "Activity"],
    "upstairs": ["Location"],
    "versus": ["Comparison/Contrast"],
    "via": ["Via", "Means", "Course"],
    "with": ["Theme", "Topic", "Recipient", "Co-Theme", "Beneficiary", "Activity", "Co-Participant", "Accompanier", "Means", "Instrument", "Stimulus", "Co-Agent", "Attribute", "Manner", "Causer", "ProfessionalAspect", "Circumstance", "3DMedium"],
    "with a view to": ["Purpose"],
    "with an eye to": ["Purpose"],
    "with an eye toward": ["Purpose"],
    "with an eye towards": ["Purpose"],
    "with the exception of": ["Elements"],
    "within": ["DeicticTime", "Location", "Superset", "Locus"],
    "without": ["Manner", "Location", "Instrument", "Circumstance", "Attribute", "Accompanier"]
};
...
ChunkLabelAnnotator.prototype.N_FILTER = function (word, pos) { return pos.match(/^(N|ADD|PROPN)/) && !pos.match(/^NUM/); };
ChunkLabelAnnotator.prototype.V_FILTER = function (word, pos) { return pos.match(/^V/); };
ChunkLabelAnnotator.prototype.NV_FILTER = function (word, pos) { return pos.match(/^(N|ADD|PROPN|V)/) && !pos.match(/^NUM/); };
